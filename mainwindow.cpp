...
MainWindow::MainWindow(QWidget *parent) :
    ...
    QObject::connect(this->ui->button_restart, &QPushButton::clicked, this, [this]() {this->chessboard->restart();});
    QObject::connect(this->ui->button_regret, &QPushButton::clicked, this, [this]() {this->chessboard->regret();});
    ...
    QObject::connect(this->ui->checkBox_blackReverse, &QCheckBox::clicked, this, [this](int state){this->chessboard->blackReverseChanges(state);});
}
